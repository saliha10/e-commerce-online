...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="post" action="{{url('/admin/add-products')}}" enctype="multipart/form-data">
                @csrf
                <div class="card mb-4">
                    ...
                    {{-- <div class="card-body">
                        <div class="row">
                            ...
                            <x-input name="product_name" title="Name" id="product_name" type="text" required/>
                            <x-input name="product_description" title="Description" id="product_description" type="text" required/>
                            <x-input name="price" title="Price" id="price" type="text" required/>
                            <x-input name="product_quantity" title="Quantity" id="product_quantity" type="text" required/>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <x-input name="product_name" title="Brand" id="product_name" type="text" required/>
                            <x-input name="product_description" title="Description" id="product_description" type="text" required/>
                            <x-input name="price" title="Price" id="price" type="text" required/>
 <x-input name="product_quantity" title="Quantity" id="product_quantity" type="text" required/>
 <div class="mb-3 col-sm-6">
    ...
    <select class="form-select" id="product_size" name="product_size">
        <option selected="" value="select">Select size</option>
 ...
 <div class="mb-3 col-sm-6">
    ...
    <input class="form-control" type="color" id="product_color" name="product_color">
</div>
                        </div>
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2">Submit</button>
