    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="post" action="{{url('/admin/add-settings')}}">
                @csrf
                <div class="card mb-4">
                    <h5 class="card-header">User-Site Settings</h5>
                    <!-- Account -->
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <x-input name="phone" title="Phone" id="phone" type="number" required/>
                            <x-input name="email" title="Email" id="email" type="email" required/>
                        </div>
                        <div class="mt-2">
